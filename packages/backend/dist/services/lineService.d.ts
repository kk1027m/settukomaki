...
export declare const formatNotificationMessage: (overdueLubrication: any[], urgentLubrication: any[], scheduledLubrication: any[], overdueReplacement: any[], urgentReplacement: any[], scheduledReplacement: any[], lowStockParts: any[], todayEvents?: any[], todayLeaves?: any[]) => string | null;
export {};
