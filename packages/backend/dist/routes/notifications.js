...
router.post('/subscribe', [
    ...
    (0, express_validator_1.body)('p256dh').notEmpty().withMessage('p256dh key is required'),
    (0, express_validator_1.body)('auth').notEmpty().withMessage('Auth key is required'),
