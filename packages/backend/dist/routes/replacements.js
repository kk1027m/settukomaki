...
router.put('/schedules/sort-order', replacementController_1.updateReplacementSortOrder);
router.get('/schedules/:id', replacementController_1.getReplacementScheduleById);
router.post('/schedules', replacementController_1.createReplacementSchedule);
router.put('/schedules/:id', replacementController_1.updateReplacementSchedule);
router.delete('/schedules/:id', replacementController_1.deleteReplacementSchedule);
// Replacement actions
router.post('/schedules/:id/perform', replacementController_1.performReplacement);
