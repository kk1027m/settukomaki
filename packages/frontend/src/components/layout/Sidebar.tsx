...
import { LayoutDashboard, Droplet, Wrench, Package, Users, Settings, FileText, Mail, X, Calendar, AlertTriangle } from 'lucide-react';
...
export default function Sidebar({ isOpen, onClose }: SidebarProps) {
  ...
  const navItems = [
    ...
    { to: '/troubleshooting', icon: AlertTriangle, label: 'トラブルシューティング' },
